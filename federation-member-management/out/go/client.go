...
// APIClient manages communication with the FHSOperator API API v0.1
...
type APIClient struct {
	...
	FHSOperatorCoreAPI *FHSOperatorCoreAPIService

	FHSOperatorFHSFHSAPI *FHSOperatorFHSFHSAPIService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.FHSOperatorCoreAPI = (*FHSOperatorCoreAPIService)(&c.common)
	c.FHSOperatorFHSFHSAPI = (*FHSOperatorFHSFHSAPIService)(&c.common)
